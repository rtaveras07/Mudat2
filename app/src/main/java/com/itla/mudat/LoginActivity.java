...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void bntRegistrate(View view) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            usuarioDbo dbo =new usuarioDbo(LoginActivity.this);
            for (Usuario credential : dbo.buscar()) {

                if (credential.getEmail().equals(mEmail)) {
                    // Account exists, return true if the password matches.
                    boolean paso= credential.getClave().equals(mPassword);

                    if(paso){
                       MainActivity.usuarioActual=credential;
                       startActivity(new Intent(LoginActivity.this,PanelActivity.class));
                       finish();
                       return true;
                    }
